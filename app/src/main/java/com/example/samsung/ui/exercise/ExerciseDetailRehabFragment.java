...
public class ExerciseDetailRehabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_exercise_detail_rehab, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.shkere); // Укажи нужную картинку
        ...
        for (int i = 0; i < exercises.length; i++) {
            ...
            exButton.setOnClickListener(v -> {
                ...
                if (allDone) {
                    Toast.makeText(getContext(), "Вы молодец! Восстановление идёт 👍", Toast.LENGTH_LONG).show();
        ...
        btnStart.setOnClickListener(v -> {
            timer = new CountDownTimer(7 * 60 * 1000, 1000) {
